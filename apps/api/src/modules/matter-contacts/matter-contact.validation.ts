...
export const createMatterContactSchema = z.object({
  contactType: z.enum(CONTACT_TYPES, {
    message: "contactType must be INDIVIDUAL or ORGANIZATION.",
  }),
...
export const updateMatterContactSchema = z.object({
...
export const linkMattersSchema = z.object({
  contacts: z.array(
    z.object({
